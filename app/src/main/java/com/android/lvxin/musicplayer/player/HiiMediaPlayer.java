...
public class HiiMediaPlayer extends MediaPlayer {
    ...
    public void setupContentData(Context context, String path) {
        try {
     ...
     * @param fileName
     */
    public void setupLocalRawData(Context context, String fileName) {
    ...
    public void setupAssets(Context context, String fileName) {
        try {
            AssetFileDescriptor assetFileDescriptor = context.getAssets().openFd(fileName + ".mp3");
